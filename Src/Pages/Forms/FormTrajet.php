        ...
        .'<div class="container-fluid">'
            ...
            .'<div class="row justify-content-around mb-5 box">'
                .'<div>'
                    ...
                    .'<input type="number" class="form-control" name="place_totale" id="place_totale" value="' . $p_totale . '" min="1" max="9" required>'
                .'</div>'
                .'<div>'
                    .'<label class="form-label" for="place_disponible">Places dispos</label>'
                    .'<input type="number" class="form-control" name="place_disponible" id="place_disponible" value="' . $p_restante . '" min="0" max="9" required>'
                .'</div>'
            .'</div>'
